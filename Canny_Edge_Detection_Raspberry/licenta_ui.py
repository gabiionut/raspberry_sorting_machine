...
class MyThread(Thread):
    def __init__(self, event, updateImageSignal, mode, setLabelSignal):
        Thread.__init__(self)
        self.stopped = False
        self.updateImageSignal = updateImageSignal
        self.mode = mode
        self.setLabelSignal = setLabelSignal
...
class Window(QWidget, QObject):
    ...
    setLabelSignal = pyqtSignal('QString')
    ...
    def __init__(self):
        ...
        self.setLabelSignal.connect(self.setLabel)
        ...
        layout.addWidget(self.textLabel, 0, 2)
    ...
    def start_clicked(self):
        print("Start clicked")
        start()
        self.thread = MyThread(self.stopFlag, self.updateImageSignal, self.mode, self.setLabelSignal)
        self.startThread()
